 ...
 *   Version 1.1: fixed column width. Code is now 80 column max.
 *                This looks a lot better in terminals.
 */
...
public class MedicalDiagnosis_KMM
{
   ...
   if (earLobePain == true) 
      ...
      {
      System.out.printf
      ("Do you have a blocked feeling in your ear that ");
       System.out.printf
      ("cannot be cleared by swallowing?\n");
      System.out.printf(pleaseEnter); 
      earBlocked = keyboard.nextBoolean(); 
         ...
         if (earGrossStuff == true) 
            {
            System.out.printf
            ("You may have an infection of the ");
            System.out.printf
            ("outer ear canal or middle ear.\n");
            }
         else
            {
            System.out.printf
